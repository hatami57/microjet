MODULES := core types utils aws messaging messaging/nats gormx gormx/migrate gormx/postgres gormx/sqlite httpx host cache jsonx otelx outbox tenant versioninfo
